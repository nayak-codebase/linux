 ...
 * 
 * Refer SDM A.3.3 Secondary Processor-Based VM-Execution Controls(A-4
Vol. 3D)
 * Check if bit 63 is set, secondary procbased controls are available
 */
void check_secondary_procbased(void)
{
	uint32_t lo, hi;
